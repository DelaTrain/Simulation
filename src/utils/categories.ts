...
const DEFAULT_CATEGORIES: Record<string, TrainCategory> = {
    ...
    d: new TrainCategory("D", "Pociąg dalekobieżny (Ukraina)", 4, 35 * 60, 44.4, 0.35),
    tlk: new TrainCategory("TLK", "Twoje Linie Kolejowe", 4, 35 * 60, 38.9, 0.35),
    ir: new TrainCategory("IR", "InterRegio", 5, 30 * 60, 38.9, 0.35),
    ar: new TrainCategory("AR", "Arriva RP", 5, 25 * 60, 38.9, 0.45),
    r: new TrainCategory("R", "Polregio", 6, 20 * 60, 33.3, 0.4),
    km: new TrainCategory("KM", "Koleje Mazowieckie", 6, 20 * 60, 33.3, 0.4),
    kd: new TrainCategory("KD", "Koleje Dolnośląskie", 6, 20 * 60, 44.4, 0.45),
    le: new TrainCategory("LE", "LeoExpress", 6, 20 * 60, 33.3, 0.45),
    skm: new TrainCategory("SKM", "Szybka Kolej Miejska (Trójmiasto)", 6, 15 * 60, 30.6, 0.5),
    ...
    zka: new TrainCategory("ZKA", "Zastępcza Komunikacja Autobusowa", 6, 20 * 60, 33.3, 0.4, true),
    l: new TrainCategory("L", "Łódzka Kolej Aglomeracyjna", 7, 15 * 60, 30.6, 0.35),
    ls: new TrainCategory("LS", "Łódzka Kolej Aglomeracyjna (sprinter)", 7, 15 * 60, 30.6, 0.35),
    ks: new TrainCategory("KS", "Koleje Śląskie", 7, 15 * 60, 30.6, 0.35),
    kw: new TrainCategory("KW", "Koleje Wielkopolskie", 7, 15 * 60, 30.6, 0.35),
    lp: new TrainCategory("LP", "Łódzka Kolej Aglomeracyjna (przyspieszony)", 7, 15 * 60, 30.6, 0.35),
    kml: new TrainCategory("KML", "Koleje Małopolskie", 7, 15 * 60, 30.6, 0.35),
    os: new TrainCategory("OS", "Koleje Śląskie (międzynarodowe)", 8, 15 * 60, 30.6, 0.3),
    bus: new TrainCategory("BUS", "Autobus", 9, 10 * 60, 22.2, 0.25, true),
